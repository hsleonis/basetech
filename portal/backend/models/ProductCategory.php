...
class ProductCategory extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['cat_title', 'cat_desc', 'cat_slug', 'sort_order'], 'required', 'on' => 'insert'],
            [['cat_title', 'cat_desc', 'cat_slug', 'sort_order'], 'required', 'on' => 'update'],
            [['cat_desc'], 'string'],
    ...
    public static function get_child_cat($parent, $options, $dot){
        ...
        $child_pages = self::find()->joinWith('cat_rel')->where(['category_self_rel.parent_cat_id'=>$parent])->all();
    ...
    public static function getHierarchy_cat() {
        ...
        $parent_pages = self::find()->joinWith('cat_rel')->where(['category_self_rel.parent_cat_id'=>0])->all();
