...
/* @var $form yii\widgets\ActiveForm */
    ...
    /*$this->registerJs("
                    ...
                    form.children('div').steps({
                        ...
                        {
                            var x = $.trim($('.file-preview-thumbnails').html());
                            if(x){
                                alert('You have some pending file uploads.');
                                return false;
                            }
                            return true;
                        }
...
<div id="wizard">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">Upload Files</a></li>
                                ...
                                ?>
                                            <li class="col-md-3 image_<?php echo $key->id; ?>" image_id="<?php echo $key->id; ?>" style="position:relative;">
                                                ...
                                                <div class="image_cont">
                                                    ...
                                                    <input type="text" name="short_title" value="<?= $key->short_title; ?>" class="page_image_info_title<?php echo $key->id; ?>">
                                                    <label>Short Description</label>
                                                    <input type="text" name="short_desc" value="<?= $key->short_desc; ?>" class="page_image_info_desc<?php echo $key->id; ?>">
