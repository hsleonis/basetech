...
(function ($) {
  ...
  $.fn.sortable = function (options) {
    ...
    return this.each(function () {
      ...
      var placeholder = ( options.placeholder === null ) ? $('<li class="sortable-placeholder col-md-3 Page_image_sort"><div class="placeholder_inner"></div></li>') : $(options.placeholder).addClass('sortable-placeholder col-md-3 Page_image_sort');
