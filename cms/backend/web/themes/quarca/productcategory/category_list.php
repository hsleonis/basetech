	...
	<div class="row">
        ...
        <div class="col-md-12">
            <div class="pane">
                ...
                <h2><span>Sub Category List</span></h2>
...
<div class="col-md-8">
    <div class="pane">
        <h2><span class="category_title"></span></h2>
    </div>
...
<!-- Modal -->
<div class="modal fade update_product_ajax" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<?php
    ...
    $this->registerJs("
        $(document).delegate('.create_cat_btn', 'click', function() { 
            $('.countries-form').slideToggle();
            return false;
        });
    ",yii\web\View::POS_READY,'toggle_form');
                            ...
                            $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        if(dt.result=='success'){
                                            ...
                                            alertify.log('Item added successfully.', 'success', 5000);
                                        }else{
    ...
    ", yii\web\View::POS_END, 'product_spec-form-update');
