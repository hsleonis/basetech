        ...
        link: function (scope, element, attr) {
          ...
          initOptions = function () {
            options = angular.extend(angular.copy(slickCarouselConfig), {
              ...
              rtl: scope.rtl === 'true',
              delay: scope.delay ? parseInt(scope.delay) : 0,
            }, scope.settings);
              ...
              slickness.on('init', function (event, slick) {
                ...
                if (typeof currentIndex !== 'undefined') {
                 ...
                 var loop = setInterval(function(){
                    if(slickness.children().length < 1){
                        ...
                        clearInterval(loop);
                        /*if($.fn.typed){
                            $(".slick-text .slide").typed({
                                strings: ["INNOVATION", "INFORMATION", "WELCOME TO BASE TECHNOLOGY"],
                                typeSpeed: 50,
                                loop: true,
                                backDelay: 500,
                            });
                        ...
                        setTimeout(function(){
                            $('.home-slick').imagesLoaded(function(){
                                $('.loader').animate(
                                    {
                                        'z-index' : '-1',
                                        'opacity' : 0
